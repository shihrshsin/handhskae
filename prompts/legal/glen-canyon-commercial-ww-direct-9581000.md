# Legal - Glen Canyon Dam 1995 FEIS Table III-16 commercial WW direct expenditures
...
In the 1995 final environmental impact statement on the operation of Glen Canyon Dam whose preferred alternative was the Modified Low Fluctuating Flow Alternative, the recreation economics discussion states that river-based recreational users generated approximately 23 million dollars in local economic activity in 1991 and presents a table of nonresident trips, direct expenditures, and local economic activity by activity. Setting aside that approximate 23-million total and the local-economic-activity column, what exact total-direct-expenditures dollar figure does that table report for commercial white-water boating in Grand Canyon? Report the number only.
...
**Step 1 - Fetch:** https://en.wikipedia.org/wiki/Glen_Canyon_Dam  
Exact on-page clues:  
