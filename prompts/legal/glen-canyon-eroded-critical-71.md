...
**Step 4 - Fetch (twin):** https://www.usbr.gov/uc/envdocs/eis/gc/pdfs/Ch3/chap3-1.pdf - Chapter 3, printed page **156**. Selectable prose: encroachment accounted for nearly **50** percent of the campsite degradation in wider (noncritical) reaches (figure III-36). Also: in narrow (critical) reaches, erosion was the primary cause of campsite degradation (no exact Critical Eroded percent in text).  
**Step 4 - Verify:** Narrative twin is "nearly 50 percent" for noncritical vegetation, not a Critical Eroded pie-slice label.  
**Step 4 - Filter:** Reject **50%** / "nearly 50 percent" as the Critical Reaches **Eroded** slice.

**Step 5 - Fetch (answer):** same Chapter 3 PDF, printed page **156** - **Figure III-36**, "Number of camps degraded by reach type and type of degradation." Two raster pies (Critical / Non-Critical). Critical Reaches labels: **Eroded 71% (29)**; Overgrown **15% (6)**; Other **7% (3)**; Eroded/Overgrown **7% (3)**. Non-Critical Reaches: Eroded **47% (91)**; Overgrown **4% (8)**; Other **27% (52)**; Eroded/Overgrown **22% (44)**. Pie numerals are image-only (no `71%` in the Chapter 3 text layer).  
**Step 5 - Verify:** Critical **Eroded** slice is **71%**.  
**Step 5 - Filter:** Lock **71%**. Dump **50%**, Non-Critical **47%**, and the other Critical slices (**15% / 7% / 7%**).

**Step 6 - Fetch (mirror check):** http://www.riversimulator.org/Resources/USBR/LTEP/1995EIS.pdf - full-bound FEIS. Text search finds the "nearly 50 percent" line and does not surface Figure III-36's Critical **Eroded 71%** as a recreation pie label (pie is raster).  
**Step 6 - Verify:** Answer is chart-image-only; twin is what search surfaces next to the figure callout.  
**Step 6 - Filter:** Keep **71%**.
...
4. https://www.usbr.gov/uc/envdocs/eis/gc/pdfs/Ch3/chap3-1.pdf - printed p.156: twin "nearly 50 percent"; Figure III-36 Critical **Eroded = 71%**.  
...
- [x] No em dashes  
- [x] Distinct from Non-Critical `47%` stump on the same figure  
