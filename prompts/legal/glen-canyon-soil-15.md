# Legal - Glen Canyon Dam FEIS / OCR Draft composition pie Soil slice
...
**Secondary traps:** Ammonium Sulfate **38%**; Remaining **36%**; Soot **9%**; haze-pie Other Fine Mass **17%** / Coarse Mass **20%**; Sulfate Fine Mass **63%** (printed on FEIS scan; not in IA OCR); NPS soil-related extinction ranges (often 10% to 30%).  
**Doc:** 1995 Glen Canyon Dam operations FEIS Chapter 3 air-quality block (usbr.gov scan has zero text layer on the pie page). Highlightable verification host: Internet Archive OCR of the 1993 Draft EIS, composition pie labeled **Figure III-31** there (= FEIS **Figure III-33**), selectable `Soil (15%)`.

---

## Prompt (83 words)

In the 1995 final environmental impact statement on the operation of Glen Canyon Dam whose preferred alternative was the Modified Low Fluctuating Flow Alternative, the air-quality discussion notes that sulfates are the primary contributors to haze at Grand Canyon and cites a 50-percent increase in summer sulfate levels measured at the canyon. Setting aside that 50-percent increase remark and the haze-contribution pie, what exact percentage does the fine-particles composition pie for Grand Canyon measurements in 1982-83 assign to Soil? Report the percentage only.
...
**Step 1 - Filter:** Identify Reclamation as author; stay on Grand Canyon air-quality / fine-particle material.
...
**Step 4 - Fetch:** https://www.usbr.gov/uc/envdocs/eis/gc/pdfs/Ch3/chap3-1.pdf - printed p.**148**. Selectable prose: **"50-percent increase in summer sulfate levels measured at the canyon (Malm, 1989)"**. Prose does not state the composition-pie Soil percentage. Printed p.**147** (Figures III-33 / III-34) is a zero-text scan on the lead-agency host.  
**Step 4 - Verify:** Distractor confirmed; Soil share is not highlightable on usbr.gov Chapter 3.  
...
**Step 6 - Search:** In https://archive.org/download/operationofglenc001993/operationofglenc001993.pdf (PDF p.**165** / printed p.**137**), text-select / search `Soil` / `Soot` / `Remaining`.  
**Step 6 - Fetch:** Selectable OCR labels on the composition pie (**Figure III-31**): Ammonium Sulfate **(38%)**; Remaining **(36%)**; **Soil (15%)**; Soot **(9%)**. Caption: "Various types of fine particles measured at Grand Canyon, 1982-83." Adjacent haze pie (next page, draft Fig. III-32) has selectable Other Fine Mass **(17%)** and Coarse Mass **(20%)** and is not the composition pie.  
**Step 6 - Verify:** Highlightable `Soil (15%)` matches the FEIS Figure III-33 Soil slice.  
**Step 6 - Filter:** Record **15%**. Discard **50%**, haze-pie **17%** / **20%**, and other composition slices **38%** / **36%** / **9%**.
...
6. https://archive.org/download/operationofglenc001993/operationofglenc001993.pdf - PDF p.165 / printed p.137: selectable **Soil (15%)** on draft Fig. III-31 (= FEIS Fig. III-33)  
