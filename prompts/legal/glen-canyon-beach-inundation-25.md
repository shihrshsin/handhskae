# Legal - Glen Canyon Dam 1995 FEIS Fig. III-37 inundation 15,000 to 25,000 cfs
...
In the Bureau of Reclamation's 1995 final environmental impact statement on the operation of Glen Canyon Dam, whose preferred alternative was the Modified Low Fluctuating Flow Alternative, the recreation analysis includes a bar chart of the percentage of camping-beach area inundated between selected discharge ranges. Body text notes that an average of 35 percent of potential campsite area is inundated when releases increase from 5,000 to 25,000 cubic feet per second. For the increase from 15,000 to 25,000 cubic feet per second, what exact percentage of beach area does that chart show as inundated?
...
**Step 4 - Filter:** Reject **35%** and **36%** as the 15,000 to 25,000 inundation-bar value.

**Step 5 - Fetch (answer):** same Chapter 3 PDF, printed page **157** (Chapter PDF page **92**) - **Figure III-37**, "Percentage of beach area inundated between discharges." Raster bar chart (scanned image; no text layer on the figure itself). Bar labels: 5,000 to 8,000 cfs = **5%**; 5,000 to 15,000 cfs = **18%**; 15,000 to 25,000 cfs = **25%**; 5,000 to 25,000 cfs = **35%**.  
**Step 5 - Verify:** The 15,000 to 25,000 cfs bar reads **25%**.  
**Step 5 - Filter:** Lock **25%**. Dump **35%**, **18%**, **5%**, and **36%**. Confirm the fourth bar (**35%**) matches the body-text twin, calibrating the chart scale.

**Step 6 - Fetch (mirror check):** http://www.riversimulator.org/Resources/USBR/LTEP/1995EIS.pdf - full-bound FEIS. Text search surfaces the body-text **35%** (5,000 to 25,000) and does not return the recreation inundation-bar **25%**, because Figure III-37 is a raster image with no text layer for that bar label. Unrelated "25 percent" hits elsewhere in the bound volume are not this bar.  
**Step 6 - Verify:** Answer is chart-image-only; twin is what search surfaces.  
**Step 6 - Filter:** Keep **25%**.
...
4. https://www.usbr.gov/uc/envdocs/eis/gc/pdfs/Ch3/chap3-1.pdf - printed p.157 twin **35%**; Figure III-37 15,000 to 25,000 cfs = **25%**.  
5. http://www.riversimulator.org/Resources/USBR/LTEP/1995EIS.pdf - full mirror; prose twin searchable; bar **25%** image-only.

---

## Failure justification

The model answered **18%**, citing the usbr.gov Chapter 3 PDF. Figure III-37's 15,000 to 25,000 cfs bar is **25%**, not 18%. **18%** is the label on the adjacent 5,000 to 15,000 cfs bar (the prior stump from this same figure). So it found the right raster chart but read the wrong discharge-range bar. The same-page body-text twin remains **35%** (5,000 to 25,000 cfs). An earlier browsing run made a different misread with **50%**.

---

## Checklist

- [x] One atomic answer (`25%`)  
...
- [x] Observed fail = wrong bar on same chart (`18%` / earlier `50%` ≠ `25%`)  
