...
**Step 4 - Filter:** Reject **50%** / "nearly 50 percent" as the Non-Critical **Eroded/Overgrown** slice.

**Step 5 - Fetch (answer):** same Chapter 3 PDF, printed page **156** - **Figure III-36**, "Number of camps degraded by reach type and type of degradation." Two raster pies (Critical / Non-Critical). Non-Critical Reaches labels: Eroded **47% (91)**; Overgrown **4% (8)**; Other **27% (52)**; **Eroded/Overgrown 22% (44)**. Critical Reaches: Eroded **71% (29)**; Overgrown **15% (6)**; Other **7% (3)**; Eroded/Overgrown **7% (3)**. Pie numerals are image-only (no `22%` recreation pie label in the Chapter 3 text layer).  
**Step 5 - Verify:** Non-Critical **Eroded/Overgrown** slice is **22%**.  
**Step 5 - Filter:** Lock **22%**. Dump **50%**, Non-Critical **47% / 27% / 4%**, and Critical **7%** Eroded/Overgrown.

**Step 6 - Fetch (mirror check):** http://www.riversimulator.org/Resources/USBR/LTEP/1995EIS.pdf - full-bound FEIS. Text search finds the "nearly 50 percent" line and does not surface Figure III-36's Non-Critical **Eroded/Overgrown 22%** as a recreation pie label (pie is raster; unrelated "22 percent" hits elsewhere in the bound volume are not this slice).  
**Step 6 - Verify:** Answer is chart-image-only; twin is what search surfaces next to the figure callout.  
**Step 6 - Filter:** Keep **22%**.
...
4. https://www.usbr.gov/uc/envdocs/eis/gc/pdfs/Ch3/chap3-1.pdf - printed p.156: twin "nearly 50 percent"; Figure III-36 Non-Critical **Eroded/Overgrown = 22%**.  
