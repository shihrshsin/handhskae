...
**Secondary traps:** haze-pie Sulfate Fine Mass **63%** (printed on FEIS scan; not in IA OCR); Other Fine Mass **17%** / Coarse Mass **20%**; Remaining **36%**; Soil **15%**; Soot **9%**; `40 to 60 percent` NPS Colorado Plateau sulfate haze summaries.  
**Doc:** 1995 Glen Canyon Dam operations FEIS Chapter 3 air-quality block (usbr.gov scan has zero text layer on the pie page). Highlightable verification host: Internet Archive OCR of the 1993 Draft EIS, composition pie labeled **Figure III-31** there (= FEIS **Figure III-33**), selectable `Ammonium Sulfate (38%)`.

---

## Prompt (84 words)

In the 1995 final environmental impact statement on the operation of Glen Canyon Dam whose preferred alternative was the Modified Low Fluctuating Flow Alternative, the air-quality discussion notes that sulfates are the primary contributors to haze at Grand Canyon and cites a 50-percent increase in summer sulfate levels measured at the canyon. Setting aside that 50-percent increase remark and the haze-contribution pie, what exact percentage does the fine-particles composition pie for Grand Canyon measurements in 1982-83 assign to Ammonium Sulfate? Report the percentage only.
...
**Step 6 - Verify:** Highlightable `Ammonium Sulfate (38%)` matches the FEIS Figure III-33 Ammonium Sulfate slice.  
**Step 6 - Filter:** Record **38%**. Discard **50%**, haze-pie **17%** / **20%**, and other composition slices **36%** / **15%** / **9%**.
